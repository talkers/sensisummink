...
#define INTERCOM_VERSION "1.1.2"
#define INTERCOM_STACK 20480

/*CHANGE THE LINE BELOW TO THE CORRECT COLOUR TERMINATOR STRING FOR YOUR
  TALKER, OR TO A "" IF YOU DO NOT HAVE COLOUR. NOTE THERE *MUST* BE
  DOUBLE QUOTES SURROUNDING THE TERMINATOR STRING*/
#define COLOUR_TERMINATOR ""
